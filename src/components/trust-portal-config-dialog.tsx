            ...
            <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2">
                        ...
                        Configure AI Trust Portal
                    </DialogTitle>
                    <DialogDescription>
                        Define what information is publicly visible on your AI Transparency Report.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="grid gap-6 py-4">
                    ...
                    <div className="grid gap-2">
                        <Label htmlFor="governance-statement">Governance Statement (The "Pledge")</Label>
                        <Textarea
                            id="governance-statement"
                            placeholder="e.g. We are committed to developing safe, transparent, and fair AI systems..."
                            className="h-32"
                            value={config.governanceStatement}
                            onChange={(e) => setConfig({ ...config, governanceStatement: e.target.value })}
                        />
                        <p className="text-xs text-muted-foreground">
                            Write a clear, non-technical statement about your organization's commitment to AI safety and ethics.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            id="contact-email"
                            type="email"
                            placeholder="ai-ethics@company.com"
                    ...
                    <div className="space-y-4 border rounded-lg p-4 bg-slate-50">
                        <h4 className="font-medium text-sm text-slate-900">Visibility Settings</h4>

                        <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                                <Label className="text-base">Show Risk Category</Label>
                                <p className="text-xs text-muted-foreground">Display the EU AI Act risk classification</p>
                            </div>
                            <Switch
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                                <Label className="text-base">Show Human Oversight</Label>
                                <p className="text-xs text-muted-foreground">Explain who oversees the AI system</p>
                            </div>
                            <Switch
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                                <Label className="text-base">Show Policies</Label>
                                <p className="text-xs text-muted-foreground">List active AI governance policies</p>
                            </div>
                            <Switch
                    ...
                    <div className="flex items-center justify-between pt-2 border-t">
                        <div className="space-y-0.5">
                            <Label className="text-base font-semibold text-indigo-900">Publish Portal</Label>
                            <p className="text-xs text-muted-foreground">Make this information publicly accessible via a unique link.</p>
                        </div>
                        <Switch
