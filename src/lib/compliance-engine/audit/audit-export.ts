...
export function generateAuditExport(
    ...
    const records: AuditRecord[] = useCases.map((uc) => {
        ...
        return {
            ...
            aiActCategory: uc.governanceAssessment?.core?.aiActCategory || 'Not assessed',
            ...
            responsibleParty: uc.responsibility?.responsibleParty || (uc.responsibility?.isCurrentlyResponsible ? 'Self' : '–'),
