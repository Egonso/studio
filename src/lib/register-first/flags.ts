...
export const registerFirstDefaultFlags: RegisterFirstFeatureFlags =
  Object.freeze({
    ...
    registerWorkflowLinks: false,
    controlShell: false,
    controlKpiHeader: false,
    controlMaturityModel: false,
    controlActionQueue: false,
...
export function getRegisterFirstFeatureFlags(
  ...
  if (env) {
    ...
    return {
      ...
      registerWorkflowLinks: parseBooleanFlag(env["NEXT_PUBLIC_REGISTER_WORKFLOW_LINKS_ENABLED"] ?? env["REGISTER_WORKFLOW_LINKS_ENABLED"]) || registerFirstDefaultFlags.registerWorkflowLinks,
  ...
  return {
    ...
    registerWorkflowLinks:
      parseBooleanFlag(process.env.NEXT_PUBLIC_REGISTER_WORKFLOW_LINKS_ENABLED) ||
      registerFirstDefaultFlags.registerWorkflowLinks,
    controlShell:
