                ...
                <Card className="w-full max-w-2xl shadow-lg">
                    ...
                    <CardContent className="space-y-6">
                        <p className="text-center text-lg font-medium">
                            Herzlichen Glückwunsch! Du hast alle Module erfolgreich abgeschlossen und bist nun bereit für die finale Zertifizierungsprüfung.
                        </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                         ...
                         <div className="space-y-4">
                            ...
                            <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
                                ...
                                <li>Bei technischen Problemen kontaktiere uns unter: <a href="mailto:officet@momofeichtinger.com" className="text-primary hover:underline">officet@momofeichtinger.com</a></li>
                            </ul>
                        </div>
                    </CardContent>
                    <CardFooter className="flex flex-col items-center gap-4">
                        ...
                        <p className="text-xs text-muted-foreground">Wir wünschen Dir viel Erfolg bei der Prüfung!</p>
                    </CardFooter>
                </Card>
            </main>
        </div>
