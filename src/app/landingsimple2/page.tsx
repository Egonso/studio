            ...
            <main className="max-w-4xl mx-auto px-6 pt-24 pb-32 relative z-10">
                ...
                <div className="text-center space-y-12 mb-24">
                    ...
                    <div className="space-y-6 max-w-3xl mx-auto">
                        <div className="flex justify-center mb-6">
                            ...
                            <div className="w-12 h-12 border-2 border-blue-900 rounded-sm flex items-center justify-center rotate-3 opacity-90">
                                <span className="font-serif text-blue-900 font-bold text-lg">印</span>
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleCapture} className="max-w-xl mx-auto relative group mt-12">
                        <div className="absolute -inset-1 bg-gradient-to-r from-blue-100 to-slate-100 rounded-lg blur opacity-40 group-hover:opacity-70 transition duration-500"></div>
                        <div className="relative flex flex-col sm:flex-row shadow-lg shadow-slate-200/50 rounded-md overflow-hidden bg-white border border-slate-200 focus-within:ring-1 focus-within:ring-blue-900 focus-within:border-blue-900 transition-all p-1">
                            <input
                                type="text"
                                value={useCaseText}
                            ...
                            <button
                                type="submit"
                                className="shrink-0 bg-blue-900 hover:bg-blue-950 text-white px-8 py-4 sm:py-0 rounded-sm text-sm font-medium transition-colors flex items-center justify-center gap-2"
                            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-32 pt-16 border-t border-slate-200">
                    <div>
                        ...
                        <div className="w-8 h-px bg-blue-900 mb-6"></div>
                    ...
                    <div className="bg-slate-50 border border-slate-100 p-8 rounded-sm">
                        ...
                        <h4 className="text-lg font-serif text-slate-900 mb-3 flex items-center gap-2">
                            <Layers className="w-5 h-5 text-blue-900" /> Von der Dokumentation zur Steuerung
                        </h4>
