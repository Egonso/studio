...
export default function LandingSimple2() {
    ...
    return (
        <div className="min-h-screen bg-[#FAFAFA] text-slate-900 font-sans selection:bg-rose-100">
            ...
            <header className="px-6 py-8 flex justify-between items-center max-w-6xl mx-auto relative z-10 w-full border-b border-slate-100">
                <div className="flex items-center gap-3 group cursor-pointer" onClick={() => router.push('/')}>
                    <div className="relative">
                        ...
                        {/* The "Inkan" Seal Accent on Logo Hover */}
                        <div className="absolute -bottom-1 -right-1 w-2 h-2 bg-rose-700 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    </div>
                    <span className="text-sm font-semibold tracking-wide text-slate-800 uppercase">AI Governance Register</span>
                </div>
                <button
                    onClick={() => router.push('/login')}
                    className="text-xs tracking-widest text-slate-500 hover:text-rose-800 transition-colors uppercase font-medium"
                >
                    Anmelden
                </button>
            </header>
            ...
            <main className="max-w-4xl mx-auto px-6 pt-24 pb-32 relative z-10">
                ...
                <div className="text-center space-y-12 mb-24">
                    ...
                    <div className="space-y-6 max-w-3xl mx-auto">
                        <div className="flex justify-center mb-6">
                            {/* The Inkan Seal representation */}
                            <div className="w-12 h-12 border-2 border-rose-800 rounded-sm flex items-center justify-center rotate-3 opacity-90">
                                <span className="font-serif text-rose-800 font-bold text-lg">印</span>
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleCapture} className="max-w-xl mx-auto relative group mt-12">
                        <div className="absolute -inset-1 bg-gradient-to-r from-rose-100 to-slate-100 rounded-lg blur opacity-40 group-hover:opacity-70 transition duration-500"></div>
                        <div className="relative flex flex-col sm:flex-row shadow-lg shadow-slate-200/50 rounded-md overflow-hidden bg-white border border-slate-200 focus-within:ring-1 focus-within:ring-rose-800 focus-within:border-rose-800 transition-all p-1">
                            <input
                                type="text"
                                value={useCaseText}
                            ...
                            <button
                                type="submit"
                                className="shrink-0 bg-rose-800 hover:bg-rose-900 text-white px-8 py-4 sm:py-0 rounded-sm text-sm font-medium transition-colors flex items-center justify-center gap-2"
                            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-32 pt-16 border-t border-slate-200">
                    <div>
                        ...
                        <div className="w-8 h-px bg-rose-800 mb-6"></div>
                    ...
                    <div className="bg-slate-50 border border-slate-100 p-8 rounded-sm">
                        ...
                        <h4 className="text-lg font-serif text-slate-900 mb-3 flex items-center gap-2">
                            <Layers className="w-5 h-5 text-rose-800" /> Von der Dokumentation zur Steuerung
                        </h4>
