...
Focus solely on the provided text and the specific task. Do not invent information. If the document is irrelevant to the task, state this in the summary and leave strengths and weaknesses empty.`,
});
